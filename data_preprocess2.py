        ...
        if filename.endswith(".csv"):
            ...
            with open(input_filepath, "r", newline="") as csvfile:
                ...
                for row in reader:
                    ...
                    new_row = {col: row[col] for col in desired_columns if col in row}
                    rows.append(new_row)
...
# Example usage:
input_directory_path = "data_sup\\csv2"  # Replace with the actual input directory path
output_directory_path = "data_sup\\csv3"  # Replace with the desired output directory path
